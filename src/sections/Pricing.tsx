            ...
            {plans.map((plan, index) => (
              ...
              >
                  ...
                  <div className="relative z-2 flex items-center justify-center">
                    ...
                    >
                      ...
                      <CountUp
                        ...
                        end={onMonthly ? plan.priceMonthly : plan.priceYearly}
                        duration={0.4}
                        useEasing={false}
                        preserveValue={true}
                      />
                    </div>
                    <div className="small-1 relative top-2 ml-1 uppercase">
                      /mo
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-10 flex w-full justify-center">
                  <Button icon={plan.icon}>{t("pricing.get_started")}</Button>
                </div>
                {index === 1 && (
                  <p className="small-compact mt-9 text-center text-p3 before:mx-2.5 before:content-['-'] after:mx-2.5 after:content-['-']">
                    {t("pricing.limited_time_offer")}
                  </p>
                )}
              </div>
            ))}
